...
\begin{poster}
  ...
  \begin{center}
    \begin{tikzpicture}[x=0.5\textwidth]
      ...
      {
      {\sffamily \Huge \textbf{Recipe Recommendation using Graph-Based Models}}\\
      {\huge\sffamily Nicholas B. DeGroot}\\
      \vspace{-0.3\baselineskip}
      {\large\sffamily University of California San Diego, USA}
      };
